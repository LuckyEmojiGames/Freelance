  ...
  return (
    <main className="relative pt-24 pb-24 w-full bg-cover bg-center bg-no-repeat min-h-full bg-[url('/images/background/background.png')] bg-cover bg-[#5200FF64]">
      ...
      <div className="px-4 mt-10">
        ...
        <textarea placeholder="Подробно опишите задание" className=" w-full text-white h-60 bg-[#0B1B35] mt-3 p-3 rounded-lg" value={description} onChange={(e) => setDescription(e.target.value)}/>
        <div>
            ...
            <label htmlFor="fileInput" className='w-full flex justify-center rounded-lg bg-blue-600 text-white h-12 mt-3 items-center'>
                <img className="px-3" src="/images/index.png" />
                Прикрепить файл
            </label>
